                ...
                <form action="<?= BASE_URL ?>/admin/patients/update/<?= $patient['id'] ?>" method="POST">
                    ...
                    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cpf" class="form-control cpf-mask" value="<?= htmlspecialchars($patient['cpf']) ?>" placeholder="000.000.000-00" required>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="text" name="main_phone" class="form-control" value="<?= htmlspecialchars($patient['main_phone']) ?>" required>
                        </div>
                        <div class="form-group" style="flex: 1; display: flex; align-items: center;">
                            <label style="display: flex; align-items: center; gap: 0.5rem; margin-top: 1.5rem; cursor: pointer;">
                                <input type="checkbox" name="has_whatsapp" value="1" <?= $patient['has_whatsapp'] ? 'checked' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="default_company_id" class="form-control">
                            ...
                            <?php foreach($companies as $c): ?>
                                <option value="<?= $c['id'] ?>" <?= $c['id'] == $patient['default_company_id'] ? 'selected' : '' ?>><?= htmlspecialchars($c['trade_name']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
