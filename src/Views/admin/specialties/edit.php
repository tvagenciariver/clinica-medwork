...
<head>
    <meta charset="UTF-8">
    <title>Editar Especialidade - MedWork</title>
    ...
    <main class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="card" style="max-width: 600px;">
                <form action="<?= BASE_URL ?>/admin/specialties/update/<?= $specialty['id'] ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            <input type="color" name="color_hex" value="<?= htmlspecialchars($specialty['color_hex']) ?>" style="width: 50px; height: 50px; border: none; border-radius: 4px; cursor: pointer; padding: 0;">
