...
<head>
    <meta charset="UTF-8">
    <title>Nova Empresa - MedWork</title>
    ...
    <main class="main-content">
        ...
        <div class="content-area">
            <div class="page-header">
                <h1 class="page-title">Cadastrar Empresa</h1>
                ...
                <form action="<?= BASE_URL ?>/admin/companies/store" method="POST">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        ...
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="text" name="cnpj" class="form-control" required placeholder="Apenas números">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="form-label">E-mail Corporativo (Usado para login da Empresa. Senha será o CNPJ)</label>
