...
<head>
    <meta charset="UTF-8">
    <title>Editar Empresa - MedWork</title>
    ...
    <main class="main-content">
        ...
        <div class="content-area">
            <div class="page-header">
                ...
                <a href="<?= BASE_URL ?>/admin/companies" class="btn btn-secondary">Voltar</a>
            </div>
            ...
            <div class="card" style="max-width: 800px;">
                <form action="<?= BASE_URL ?>/admin/companies/update/<?= $company['id'] ?>" method="POST">
                    
                    <div style="display: flex; gap: 1rem;">
                        <div class="form-group" style="flex: 2;">
                            <label class="form-label">Razão Social *</label>
                            <input type="text" name="corporate_name" class="form-control" value="<?= htmlspecialchars($company['corporate_name']) ?>" required>
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label class="form-label">CNPJ *</label>
                            <input type="text" name="cnpj" class="form-control" value="<?= htmlspecialchars($company['cnpj']) ?>" required placeholder="Apenas números">
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <div class="form-group" style="flex: 2;">
                            ...
                            <input type="text" name="trade_name" class="form-control" value="<?= htmlspecialchars($company['trade_name']) ?>">
                        </div>
                        <div class="form-group" style="flex: 1;">
                            <label class="form-label">Responsável (RH/Diretoria)</label>
                            <input type="text" name="manager_name" class="form-control" value="<?= htmlspecialchars($company['manager_name']) ?>">
                        </div>
                    </div>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <div class="form-group" style="flex: 1;">
                            ...
                            <input type="text" name="main_phone" class="form-control" value="<?= htmlspecialchars($company['main_phone']) ?>">
                        </div>
                        <div class="form-group" style="flex: 1; display: flex; align-items: center;">
                            <label style="display: flex; align-items: center; gap: 0.5rem; margin-top: 1.5rem; cursor: pointer;">
                                <input type="checkbox" name="has_whatsapp" value="1" <?= $company['has_whatsapp'] ? 'checked' : '' ?>>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <div class="form-group" style="flex: 2;">
                            <label class="form-label">E-mail Corporativo (Login do Portal)</label>
                    ...
                    <div style="margin-top: 2rem;">
                        <button type="submit" class="btn btn-primary"><i class="fa-solid fa-save"></i> Atualizar Empresa</button>
                    </div>
                </form>
            </div>
        </div>
